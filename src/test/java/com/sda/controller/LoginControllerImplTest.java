...
class LoginControllerImplTest {
    ...
    void whenUserLoginDataIsCorrectShouldReturnMainMenuView(){
        ...
        // when
        View result = loginController.login(new UserLoginData(CORRECT_LOGIN, CORRECT_PASSWORD));
        // then
    ...
    void whenUserLoginDataIsCorrectShouldReturnLoginView(){
        ...
        // when
        View result = loginController.login(new UserLoginData(INCORRECT_LOGIN, ""));
        // then
    ...
    void whenUserLoginExistButPasswordIsIncorrectShouldReturnLoginView(){
        ...
        // when
        View result = loginController.login(new UserLoginData(CORRECT_LOGIN, INCORRECT_PASSWORD));
        // then
        assertThat(result).isInstanceOf(LoginView.class);
    }
